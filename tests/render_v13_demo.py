"""
render_v13_demo.py — v13 시연 STEP → 4방향 PNG
================================================
matplotlib headless 렌더 (freecadcmd 환경).

산출:
  output/v13_demo_iso.png   — 등각투영 (30°, 45°)
  output/v13_demo_top.png   — 평면 (90°, -90°)
  output/v13_demo_north.png — 북측 입면 (0°, -90°)
  output/v13_demo_east.png  — 동측 입면 (0°, 0°)

실행:
  "C:/Program Files/FreeCAD 1.1/bin/freecadcmd.exe" tests/render_v13_demo.py
"""
import os, sys, time
...
title_base = f'v13 시연 — 101동 B2F (COLUMN+BEAM+WALL {n_solids}개)'
...
for name, elev, azim in VIEWS:
    ...
    out = f'output/v13_demo_{name}.png'
