...
class StepZoneMap:
    ...
    def summary(self) -> str:
        ...
        lines = [f'[StepZoneMap] {len(self.zones)}개 단차 구역']
...
# "B2F SL -1.8" → floor=B2F, delta=-1800mm
# "B2F SL +1650" → floor=B2F, delta=+1650mm
...
def parse_step_zones(dxf_path: str, encoding: str = 'auto',
    ...
    return StepZoneMap(zones=zones, base_sl=base_sl)
